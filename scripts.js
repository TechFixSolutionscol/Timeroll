document.addEventListener('DOMContentLoaded', () => {
    ...
    const appState = {
        clients: [], // Data will be fetched from the backend
        timer: {
            interval: null,
            startTime: 0,
            elapsedTime: 0,
    ...
    function generateEmailDraft() {
        ...
        google.script.run
            ...
            .generateEmailDraftBackend(appState.currentInvoiceData);
    }
    ...
    elements.loginButton.addEventListener('click', () => {
        ...
        google.script.run.withSuccessHandler(response => {
            if (response.success) {
                appState.loggedInUser = response.user;
                showApp();
            } else {
    ...
    elements.createTablesButton.addEventListener('click', () => {
        elements.createTablesButton.disabled = true;
        elements.createTablesButton.textContent = 'Creando...';
        google.script.run.withSuccessHandler(response => {
            if (response.success) {
            ...
            elements.createTablesButton.disabled = false;
            elements.createTablesButton.textContent = '¿Primera vez? Crea las tablas de la base de datos aquí';
        }).createTables();
    });
    ...
    elements.clientForm.addEventListener('submit', (e) => {
        ...
        if (id) {
            ...
            google.script.run.withSuccessHandler((newClient) => {
