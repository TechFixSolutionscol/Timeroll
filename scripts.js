document.addEventListener('DOMContentLoaded', () => {
    ...
    const elements = {
        ...
        currentUserDisplay: $('#current-user-display'),
    };
    ...
    function showToast(message, isError = false) {
        ...
        elements.toast.classList.toggle('dark:bg-red-700', isError);
        elements.toast.classList.toggle('bg-green-500', !isError);
        elements.toast.classList.toggle('dark:bg-green-700', !isError);
    ...
    function loadClients() {
        google.script.run
            ...
            .withFailureHandler(e => showToast(`Error loading clients: ${e.message}`, true))
            .getClients();
    }
    ...
    function handleClientFormSubmit(e) {
        ...
        const submissionButton = elements.clientForm.querySelector('button[type="submit"]');
        submissionButton.disabled = true;
        submissionButton.textContent = 'Guardando...';

        const onFinally = () => {
             submissionButton.disabled = false;
             submissionButton.textContent = 'Guardar Cliente';
        };
    ...
    function handleDeleteClient(id, button) {
        ...
        google.script.run
            .withSuccessHandler(response => {
                ...
                if (response.success) {
                    ...
                    elements.currentUserDisplay.textContent = `Usuario: ${appState.currentUser.username}`;
            ...
            .withFailureHandler(e => {
                 onFinally();
                 elements.loginError.textContent = `Error: ${e.message}`;
                 elements.loginError.classList.remove('hidden');
            })
    ...
    function generateEmailDraft() {
        ...
        google.script.run
            ...
            .withFailureHandler(e => {
                onFinally();
                elements.emailDraftDisplay.textContent = `Error: ${e.message}`;
            })
